...
// Constructor
    function __construct($pString = FALSE, $helpLink = TRUE) {
...
<link rel="stylesheet" href="/assets/osbib.css" type="text/css" />
...
END1;
        if ($helpLinkDisplay) {
            $pString .= <<< END2
		<td class="" align="left" valign="top">
			<a class="link" href="create.php">
			Home
			</a>
		</td>
		<td class="" align="right" valign="top">
			<a class="link" href="create.php?action=help" target="_blank">
			$helpLink
			</a>
		</td>
