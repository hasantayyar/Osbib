...
// Constructor
    function __construct() {
        $linkSfWikindx = MISC::a("link", "WIKINDX Sourceforge Project", "http://sourceforge.net/projects/wikindx/", "_blank");
////////////////////////////////////////////////////////////////////////////////////
...
// Help page
    function display() {
        $this->template->setVar('heading', $this->utf8->decodeUtf8($this->messages->text("heading", "helpStyles")));
